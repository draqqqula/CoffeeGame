...
namespace BehaviorKit
{
    ...
    public class DamageInstance
    {
        ...
        public DamageInstance(Dictionary<DamageType, int> damage, Team team, HashSet<string> tags, string mainTag, Dummy owner,
            List<Condition> conditions, List<DamageEvent> events, TimeSpan invincibilityGift)
        {
            Damage = damage;
            Team = team;
            Tags = tags;
